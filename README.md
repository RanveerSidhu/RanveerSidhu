...
**Senior Full-Stack .NET Developer** · 9+ years · Based in India · **Open to Remote Roles Worldwide**

📧 [ranveer.sidhu91@gmail.com](mailto:ranveer.sidhu91@gmail.com) · [LinkedIn](https://linkedin.com/in/ranveersinghsidhu) · [GitHub](https://github.com/RanveerSidhu)

---

### 🔧 Tech Stack

**Backend:** `ASP.NET Core` `C#` `Web APIs` `Entity Framework Core` `Dapper` `SQL Server` `REST APIs`

**Frontend:** `React` `JavaScript` `TypeScript` `Vite` `Ant Design` `Tailwind CSS`

**DevOps & Cloud:** `Docker` `GitHub Actions` `Azure` `Railway`

**Architecture:** `Clean Architecture` `SOLID Principles` `Repository Pattern` `JWT Authentication` `OAuth2` `RESTful API Design` `CI/CD`
...
- Modern auth integrations — replacing legacy SMTP/Basic Auth with OAuth2 + Microsoft Graph
...
| [GraphMailRelay](https://github.com/RanveerSidhu/GraphMailRelay) | Sends email via Microsoft Graph API using OAuth2 client credentials — a modern replacement for SMTP now that Microsoft 365 enforces MFA | Solves the Basic Auth/MFA deprecation blocker for unattended services; includes unit tests and a documented Windows Server troubleshooting case study | C#, .NET, Microsoft Graph SDK, MSAL |
...
I'm looking for **remote Senior .NET Developer** or **Senior Full-Stack Developer** roles — open to companies of any size or industry, anywhere in the world.

- ✅ 9+ years of professional experience
- ✅ Strong background in enterprise systems and API design
- ✅ Fully remote-ready — based in India, no relocation or visa sponsorship required
- ✅ Available for interviews immediately
- ✅ Comfortable working across time zones for the right opportunity

If you're hiring remotely and need senior .NET talent — let's talk.
